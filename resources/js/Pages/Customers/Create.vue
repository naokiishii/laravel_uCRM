...
<template>
    <Head title="Register a Customer" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Register a Customer</h2>
        </template>
                                    ...
                                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                        <div class="flex flex-wrap -m-2">
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="name" class="leading-7 text-sm text-gray-600">Customer
                                                        Name</label>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="kana" class="leading-7 text-sm text-gray-600">Customer
                                                        Name Kana</label>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="tel" class="leading-7 text-sm text-gray-600">Phone Number
                                                    </label>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="birthday" class="leading-7 text-sm text-gray-600">Birthday
                                                    </label>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label class="leading-7 text-sm text-gray-600">Gender
                                                    </label>
                                                    <input for="gender0" class="ml-4" type="radio" id="gender0"
                                                        name="gender" v-model="form.gender" value="0">
                                                    <label>male</label>
                                                    <input for="gender1" class="ml-4" type="radio" id="gender1"
                                                        name="gender" v-model="form.gender" value="1">
                                                    <label>female</label>
                                                    <input for="gender2" class="ml-4" type="radio" id="gender2"
                                                        name="gender" v-model="form.gender" value="2">
                                                    <label>others</label>
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <button
                                                    class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Register
                                                    a Customer</button>
                                            </div>
                                        </div>
                                    </div>
